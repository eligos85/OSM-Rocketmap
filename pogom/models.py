    ...
    def get_active(swLat, swLng, neLat, neLng, timestamp=0, oSwLat=None,
        ...
        if args.hide_encounters:
            query = Pokemon.select(
                ...
                Pokemon.move_2=NULL,
                Pokemon.cp=NULL,
                Pokemon.cp_multiplier=NULL,
                Pokemon.weight=NULL,
                Pokemon.height=NULL,
                Pokemon.gender=NULL,
                Pokemon.form=NULL,
                Pokemon.costume=NULL,
                Pokemon.catch_prob_1=NULL,
                Pokemon.catch_prob_2=NULL,
                Pokemon.catch_prob_3=NULL,
                Pokemon.rating_attack=NULL,
                Pokemon.rating_defense=NULL,
